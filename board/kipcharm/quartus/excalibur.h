/* megafunction wizard: %ARM-Based Excalibur%
   ...
   PROJECT: cia2
   ============================================================
   File Name: /home/rpanse/Projects/CIA2/svn/CIA2/hardware/projects/CHARM_FULL/Quartus/ARM_Stripe.h
...
#ifndef	CIA2_H_INCLUDED
#define	CIA2_H_INCLUDED

#define EXC_DEFINE_PROCESSOR_LITTLE_ENDIAN
#define EXC_DEFINE_BOOT_FROM_FLASH

#define	EXC_INPUT_CLK_FREQUENCY (40000000)
#define	EXC_AHB1_CLK_FREQUENCY (100000000)
#define	EXC_AHB2_CLK_FREQUENCY (50000000)
#define	EXC_SDRAM_CLK_FREQUENCY (100000000)
...
#define	EXC_EBI_BLOCK3_SIZE (0x00040000)
...
#define	EXC_SPSRAM_BLOCK1_BASE (0x20040000)
#define	EXC_SPSRAM_BLOCK1_SIZE (0x00004000)

/* PLD Block(s) */
#define	EXC_PLD_BLOCK0_BASE (0x80000000)
#define	EXC_PLD_BLOCK0_SIZE (0x00020000)
#define	EXC_PLD_BLOCK0_NON_CACHEABLE
#define	EXC_PLD_BLOCK1_BASE (0x81000000)
#define	EXC_PLD_BLOCK1_SIZE (0x00040000)
#define	EXC_PLD_BLOCK1_NON_CACHEABLE
#define	EXC_PLD_BLOCK2_BASE (0x82000000)
#define	EXC_PLD_BLOCK2_SIZE (0x00020000)
#define	EXC_PLD_BLOCK2_NON_CACHEABLE
#define	EXC_PLD_BLOCK3_BASE (0x83000000)
#define	EXC_PLD_BLOCK3_SIZE (0x00040000)
