...
/* Default to AMD */
void (*epxa_flash_print_info)(flash_info_t *info)=amd_flash_print_info;
int (*epxa_flash_erase) (flash_info_t *info, int s_first, int s_last)=amd_flash_erase;
int (*epxa_write_buff) (flash_info_t *info, uchar *src, ulong addr, ulong cnt)=amd_write_buff;
int (*epxa_flash_read_user)(int bank, int offset)=amd_flash_read_user;
