...
#define SMC_BASE_ADDRESS (EXC_EBI_BLOCK3_BASE + 0x300)
...
#define CONFIG_BOOTARGS    	"root=/dev/nfs mem=16M console=ttyUA0,57600 nfsroot=/usr/devel/flashdisk_top/%s,rsize=4096,wsize=4096 ip=137.57.134.44:137.57.134.41:137.57.134.254:255.255.255.0:epxa1db-1:eth0:off"
...
#define	CFG_PROMPT		"epxa1db # "	/* Monitor Command Prompt	*/
