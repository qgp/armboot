/*
 *
 * Configuation settings for the KIP DCS Board.
 *
...
#define CONFIG_BOOTARGS    	"root=/dev/mtdblock/0 mem=32M rootfstype=jffs2 console=ttyUA0,57600"
...
#define	CFG_PROMPT		"dcs # "	/* Monitor Command Prompt	*/
